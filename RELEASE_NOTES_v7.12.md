# NOFA AI Evaluator v7.12 Release Notes

## 🎉 What's New

### Nonprofit-Appropriate Evaluation
...
1. Download `NOFA_AI_Evaluator_v7.12.html` from the **Assets** section below
...
1. Open `NOFA_AI_Evaluator_v7.12.html` in a **text editor** (like Notepad or VS Code)
